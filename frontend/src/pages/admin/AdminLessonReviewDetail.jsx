...
import "../teacher/TeacherLessonDetail.css";

function AdminLessonReviewDetail() {
  ...
  const loadLessonDetail = async () => {
    try {
      ...
      /*
        API gợi ý backend:
        GET /admin/courses/{courseId}/lessons/{lessonId}/review

        Response nên giống TeacherLessonDetailResponse:
        {
          lessonId,
          courseId,
          courseTitle,
      ...
      */
      ...
      if (!response.ok) {
        setError(data?.message || "Không thể tải chi tiết bài học để review");
        return;
      }
  ...
  const countEnabledContent = () => {
    let count = 0;

    if (videos.length > 0) count++;
    if (vocabularies.length > 0) count++;
    if (grammars.length > 0) count++;
    ...
    <div className="teacher-lesson-detail-page">
      <div className="lesson-detail-heading">
        <div>
          ...
          <p>
            {lesson.description ||
              "Bài học chưa có mô tả. Admin nên kiểm tra nội dung liên quan trước khi duyệt khóa học."}
          </p>
        </div>
        ...
        <div className="lesson-status-panel">
          ...
          <div className="progress lesson-progress">
            <div
              ...
              style={{
                width: `${lesson.progressPercent || countEnabledContent() * 25}%`,
              }}
            ></div>
          </div>

          <small className="text-muted">
            Mức hoàn thiện nội dung:{" "}
            {lesson.progressPercent || countEnabledContent() * 25}%
          </small>
        </div>
      </div>
      ...
      <div className="lesson-summary-grid">
        ...
        >
          ...
          <div>
            ...
            <small className="text-muted d-block">Click để review</small>
          </div>
        </button>
        ...
        <button
          ...
          onClick={() =>
            navigate(
              `/admin/courses/${courseId}/lessons/${lessonId}/vocabularies`
            )
          }
        >
        ...
        <button
          ...
          onClick={() =>
            navigate(
              `/admin/courses/${courseId}/lessons/${lessonId}/grammars`
            )
          }
        >
        ...
        <button
          ...
          onClick={() =>
            navigate(
              `/admin/courses/${courseId}/lessons/${lessonId}/practice`
            )
          }
        >
      ...
      <div className="lesson-content-card">
        ...
        <div className="tab-content-box">
          ...
          <div className="alert alert-info mt-4">
            ...
            từ vựng, ngữ pháp và câu hỏi ôn tập phù hợp với nội dung bài học hay
            chưa. Nếu thiếu nội dung quan trọng, có thể từ chối khóa học ở màn
            duyệt khóa học.
          </div>
          ...
          <div className="row g-3 mt-3">
            ...
            <div className="col-md-4">
              <div className="small-info-box">
                ...
                <strong>
                  {videos.length} video · {vocabularies.length} từ ·{" "}
...
export default AdminLessonReviewDetail;