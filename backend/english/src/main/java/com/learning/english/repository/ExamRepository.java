...
public interface ExamRepository extends JpaRepository<Exam, Long> {
    ...
    // Lấy tất cả kỳ thi, sắp xếp theo ngày tạo giảm dần (mới nhất lên đầu)
    List<Exam> findAllByOrderByCreatedAtDesc();

    // Lọc kỳ thi theo trạng thái, sắp xếp theo ngày tạo giảm dần
    List<Exam> findByStatusOrderByCreatedAtDesc(String status);

    // Đếm số kỳ thi theo trạng thái
