    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(request -> request
                ...
                .requestMatchers(HttpMethod.GET, "/khoa-hoc/danh-sach-khoa-hoc-public", "/images/**", "/videos/**", "/level/*").permitAll()
                ...
                .requestMatchers(HttpMethod.GET, "/lesson/all-lesson/*").hasAnyAuthority("SCOPE_student")
